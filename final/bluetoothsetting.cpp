    ...
    ui(new Ui::bluetoothSetting)
{
    ...
    ui->Device_Label->setAlignment(Qt::AlignCenter);
    ui->X_Label->setAlignment(Qt::AlignCenter);
    ui->Y_Label->setAlignment(Qt::AlignCenter);
    ui->D_Label->setAlignment(Qt::AlignCenter);
    ui->T_Label->setAlignment(Qt::AlignCenter);
    ui->P_Label->setAlignment(Qt::AlignCenter);
    ui->Q_Label->setAlignment(Qt::AlignCenter);
    ui->R_Label->setAlignment(Qt::AlignCenter);
    ui->label_14->setAlignment(Qt::AlignCenter);
    ui->label_15->setAlignment(Qt::AlignCenter);
    ui->label_16->setAlignment(Qt::AlignCenter);
    ui->zero_d->setAlignment(Qt::AlignCenter);
    ui->zero_p->setAlignment(Qt::AlignCenter);
    ui->zero_q->setAlignment(Qt::AlignCenter);
    ui->zero_r->setAlignment(Qt::AlignCenter);
    ui->zero_t->setAlignment(Qt::AlignCenter);
    ui->zero_x->setAlignment(Qt::AlignCenter);
    ui->zero_y->setAlignment(Qt::AlignCenter);
    ui->one_d->setAlignment(Qt::AlignCenter);
    ui->one_p->setAlignment(Qt::AlignCenter);
    ui->one_q->setAlignment(Qt::AlignCenter);
    ui->one_r->setAlignment(Qt::AlignCenter);
    ui->one_t->setAlignment(Qt::AlignCenter);
    ui->one_x->setAlignment(Qt::AlignCenter);
    ui->one_y->setAlignment(Qt::AlignCenter);
    ui->two_d->setAlignment(Qt::AlignCenter);
    ui->two_p->setAlignment(Qt::AlignCenter);
    ui->two_q->setAlignment(Qt::AlignCenter);
    ui->two_r->setAlignment(Qt::AlignCenter);
    ui->two_t->setAlignment(Qt::AlignCenter);
    ui->two_x->setAlignment(Qt::AlignCenter);
    ui->two_y->setAlignment(Qt::AlignCenter);
    ui->zero_d->setText(QString::number(kalman_filter[0].X));
    ui->zero_p->setText(QString::number(kalman_filter[0].P));
    ui->zero_q->setText(QString::number(kalman_filter[0].Q));
    ui->zero_r->setText(QString::number(kalman_filter[0].R));
    ui->zero_t->setText(QString::number(tx_power[0]));
    ui->zero_x->setText(QString::number(device_x_pos[0]));
    ui->zero_y->setText(QString::number(device_y_pos[0]));
    ui->one_d->setText(QString::number(kalman_filter[1].X));
    ui->one_p->setText(QString::number(kalman_filter[1].P));
    ui->one_q->setText(QString::number(kalman_filter[1].Q));
    ui->one_r->setText(QString::number(kalman_filter[1].R));
    ui->one_t->setText(QString::number(tx_power[1]));
    ui->one_x->setText(QString::number(device_x_pos[1]));
    ui->one_y->setText(QString::number(device_y_pos[1]));
    ui->two_d->setText(QString::number(kalman_filter[2].X));
    ui->two_p->setText(QString::number(kalman_filter[2].P));
    ui->two_q->setText(QString::number(kalman_filter[2].Q));
    ui->two_r->setText(QString::number(kalman_filter[2].R));
    ui->two_t->setText(QString::number(tx_power[2]));
    ui->two_x->setText(QString::number(device_x_pos[2]));
    ui->two_y->setText(QString::number(device_y_pos[2]));
...
void bluetoothSetting::on_pushButton_2_clicked()
{
 ...
 //   dlg.setGeometry(300, 300, 400, 400);
    ...
    if(ui->PiZeroW->isChecked())
    {
        ...
        if(value != 0)kalman_filter[0].X = value;
        QMessageBox msgBox;
 ...
 //       msgBox.exec();
    ...
    else if(ui->PiOneCaseO->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[1].X = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
    ...
    else if(ui->PiOneCaseX->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[2].X = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
...
//    dlg.setGeometry(300, 300, 400, 400);
    if(ui->PiZeroW->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[0].Q = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
    ...
    else if(ui->PiOneCaseO->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0) kalman_filter[1].Q = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
    ...
    else if(ui->PiOneCaseX->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[2].Q = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
  //      msgBox.exec();
...
void bluetoothSetting::on_pushButton_3_clicked()
{
 ...
 //   dlg.setGeometry(300, 300, 400, 400);
    if(ui->PiZeroW->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[0].P = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
  //      msgBox.exec();
    ...
    else if(ui->PiOneCaseO->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[1].P = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
    ...
    else if(ui->PiOneCaseX->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[2].P = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
...
//    dlg.setGeometry(300, 300, 400, 400);
            ...
            ->PiZeroW->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[0].R = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
//        msgBox.exec();
    ...
    else if(ui->PiOneCaseO->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[1].R = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
    ...
    else if(ui->PiOneCaseX->isChecked())
    {
        ...
        dlg.GetString(ValueCharString);
        double value = atof(ValueCharString);
        if(value != 0)kalman_filter[2].R = value;
        QMessageBox msgBox;
        msgBox.setText("The value has successfully changed.");
 //       msgBox.exec();
